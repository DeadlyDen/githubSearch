...
/**
 * Created by den on 22.05.18.
 */

public abstract class EndlessNestedViewScrollListener implements NestedScrollView.OnScrollChangeListener {
    ...
    public EndlessNestedViewScrollListener(RecyclerView.LayoutManager layoutManager) {
